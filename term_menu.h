...
struct MyTerminalMenus {
  ...
  MyTerminalMenus(WindowHolder *w, ToolkitInterface *t) : win(w), toolkit(t),
    ...
    key_icon               (CheckNotNull(app->system_toolkit->LoadImage("key"))),
    host_icon              (CheckNotNull(app->system_toolkit->LoadImage("host"))),
    host_locked_icon       (CheckNotNull(app->system_toolkit->LoadImage("host_locked"))),
    bolt_icon              (CheckNotNull(app->system_toolkit->LoadImage("bolt"))),
    terminal_icon          (CheckNotNull(app->system_toolkit->LoadImage("terminal"))),
    settings_blue_icon     (CheckNotNull(app->system_toolkit->LoadImage("settings_blue"))),
    settings_gray_icon     (CheckNotNull(app->system_toolkit->LoadImage("settings_gray"))),
    audio_icon             (CheckNotNull(app->system_toolkit->LoadImage("audio"))),
    eye_icon               (CheckNotNull(app->system_toolkit->LoadImage("eye"))),
    recycle_icon           (CheckNotNull(app->system_toolkit->LoadImage("recycle"))),
    fingerprint_icon       (CheckNotNull(app->system_toolkit->LoadImage("fingerprint"))),
    info_icon              (CheckNotNull(app->system_toolkit->LoadImage("info"))),
    keyboard_icon          (CheckNotNull(app->system_toolkit->LoadImage("keyboard"))),
    folder_icon            (CheckNotNull(app->system_toolkit->LoadImage("folder"))),
    logo_image             (CheckNotNull(app->system_toolkit->LoadImage("logo"))),
    logo_icon              (CheckNotNull(app->system_toolkit->LoadImage("logo_icon"))),
    plus_red_icon          (CheckNotNull(app->system_toolkit->LoadImage("plus_red"))),
    plus_green_icon        (CheckNotNull(app->system_toolkit->LoadImage("plus_green"))),
    vnc_icon               (CheckNotNull(app->system_toolkit->LoadImage("vnc"))),
    locked_icon            (CheckNotNull(app->system_toolkit->LoadImage("locked"))),
    unlocked_icon          (CheckNotNull(app->system_toolkit->LoadImage("unlocked"))),
    font_icon              (CheckNotNull(app->system_toolkit->LoadImage("font"))),
    toys_icon              (CheckNotNull(app->system_toolkit->LoadImage("toys"))),
    arrowleft_icon         (CheckNotNull(app->system_toolkit->LoadImage("arrowleft"))),
    arrowright_icon        (CheckNotNull(app->system_toolkit->LoadImage("arrowright"))),
    clipboard_upload_icon  (CheckNotNull(app->system_toolkit->LoadImage("clipboard_upload"))),
    clipboard_download_icon(CheckNotNull(app->system_toolkit->LoadImage("clipboard_download"))),
    keygen_icon            (CheckNotNull(app->system_toolkit->LoadImage("keygen"))),
    user_icon              (CheckNotNull(app->system_toolkit->LoadImage("user"))),
    calendar_icon          (CheckNotNull(app->system_toolkit->LoadImage("calendar"))),
    check_icon             (CheckNotNull(app->system_toolkit->LoadImage("check"))),
    stacked_squares_icon   (CheckNotNull(app->system_toolkit->LoadImage("stacked_squares_blue"))),
    ex_icon                (CheckNotNull(app->system_toolkit->LoadImage("ex"))),
    none_icon              (CheckNotNull(app->system_toolkit->LoadImage("none"))),
  ...
  void UpdateTabThumbnailSystemImage(TerminalTabInterface *t, const Box &iconb) {
    ...
    if (!t->thumbnail_system_image) t->thumbnail_system_image = app->system_toolkit->LoadImage("");
    app->system_toolkit->UpdateImage(t->thumbnail_system_image, icon_tex);
  }
